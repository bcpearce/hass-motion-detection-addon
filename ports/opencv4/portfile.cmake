...
set(WITH_QT OFF)
if("qt" IN_LIST FEATURES AND "highgui" IN_LIST FEATURES)
...
if(NOT "highgui" IN_LIST FEATURES)
  list(APPEND ADDITIONAL_BUILD_FLAGS "-DBUILD_opencv_highgui=OFF")
  list(APPEND ADDITIONAL_BUILD_FLAGS "-DWITH_QT=OFF")
  list(APPEND ADDITIONAL_BUILD_FLAGS "-DWITH_GTK=OFF")
  list(APPEND ADDITIONAL_BUILD_FLAGS "-DWITH_WIN32UI=OFF")
endif()
