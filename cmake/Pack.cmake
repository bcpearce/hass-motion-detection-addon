...
if (CMAKE_SYSTEM_NAME STREQUAL "Linux")
    ...
    if("${OS_RELEASE_CONTENT}" MATCHES "ID=debian" OR "${OS_RELEASE_CONTENT}" MATCHES "ID_LIKE=debian")
...
elseif (CMAKE_SYSTEM_NAME STREQUAL "Windows")
    file(COPY ${CPACK_RESOURCE_FILE_LICENSE} DESTINATION ${CMAKE_BINARY_DIR}/LICENCE.TXT)
